...
-I ${GITHUB_WORKSPACE}/entservices-testframework/Tests/mocks/thunder/devicesettings \
...
-include ${GITHUB_WORKSPACE}/entservices-testframework/Tests/mocks/devicesettings/MotionDetectionMock.h \
